...
ActiveRecord::Schema.define(version: 20_200_402_194_639) do
  ...
  create_table 'collection_products', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[collection_id product_id], name: 'index_collection_products_on_collection_id_and_product_id', unique: true
