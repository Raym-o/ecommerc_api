...
class ProvincesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create province" do
    assert_difference('Province.count') do
      post provinces_url, params: { province: { hst_rate: @province.hst_rate, name: @province.name, pst_rate: @province.pst_rate } }
    end
  ...
  test "should update province" do
    patch province_url(@province), params: { province: { hst_rate: @province.hst_rate, name: @province.name, pst_rate: @province.pst_rate } }
